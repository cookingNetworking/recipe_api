...
@extend_schema(
    ...
    examples=[
        OpenApiExample(
            "User created!",
            value={
                "message": "User created, please check your email to active your account in 15 minutes !",
                "token": "Token that sendiing to email of user",
            },
            response_only=True,
            status_codes=["201"],
        ),
        OpenApiExample(
            ...
            value={
                ...
                "detail": "Please provide an email or password.",
            },
            response_only=True,
            status_codes=["400"],
        ),
...
class CreateUserView(generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            ...
            payload = {"email": email, "exp": current_time + (15 * 60)}
            ...
            return Response(
                {"error": str(e), "detail": "Please check again!"},
                status=status.HTTP_400_BAD_REQUEST,
            )
    ...
    examples=[
        OpenApiExample(
            ...
            value={
                ...
                "detail": "user detai example: {'email': 'superuser@django.com', 'username': 'example', 'role': 'user'}",
            },
        ...
        OpenApiExample(
            ...
            value={
                "error": "Error message ",
                "detail": "Please login again!!Email not found!!",
            },
        ...
        OpenApiExample(
            ...
            value={
                "error": "Account is not been active!",
        ...
        OpenApiExample(
            ...
            value={
                ...
                "detail": "Please ensure user fill in the email!!",
            },
        ...
        OpenApiExample(
            ...
            value={
                ...
                "detail": "Please ensure user fill in  the password!!",
            },
...
class LoginView(APIView):
    ...
    def post(self, request):
        if request.user.is_authenticated:
            return Response(
                {"error": "Already login!", "detail": "please redirect to home page!"},
                status=status.HTTP_400_BAD_REQUEST,
            )
        ...
        return Response(
            {"error": serializer.errors, "detail": "Please login again!"},
            status=status.HTTP_400_BAD_REQUEST,
        )
            ...
            return Response(
                {
                    ...
                    "detail": "Session id remove from cookies!",
                },
                status=status.HTTP_200_OK,
            )
        except Exception as e:
...
@extend_schema(
    ...
    examples=[
        OpenApiExample(
            "Email okay",
            value={
                "message": "Email check ok!",
                "detail": "User could use this email!",
            },
            response_only=True,
            status_codes=["200"],
        ),
        OpenApiExample(
            ...
            value={
                ...
                "detail": "Please use another email.",
            },
            response_only=True,
            status_codes=["400"],
        ),
...
def check_email_replicate(request):
    ...
    try:
        ...
        return Response(
            {"message": "Email check ok!", "detail": "User could use this email!"},
            status=status.HTTP_200_OK,
        )
    except Exception as e:
        print(e)
...
@extend_schema(
    ...
    examples=[
        OpenApiExample(
            "Username check okay",
            value={
                "message": "Username check ok!",
                "detail": "Username could use this email!",
            },
            response_only=True,
            status_codes=["200"],
        ),
        OpenApiExample(
            ...
            value={
                ...
                "detail": "Please use another username.",
            },
            response_only=True,
            status_codes=["400"],
        ),
...
def check_username_replicate(request):
    ...
    try:
        ...
        return Response(
            {
                "message": "username check ok!",
                "detail": "User could use this username!",
            },
            status=status.HTTP_200_OK,
        )
    except Exception as e:
...
@extend_schema(
    ...
    examples=[
        OpenApiExample(
            "Email exist Error",
            value={
                "message": "User is been actived!!!",
                "detail": "Redirect to login page, please login cookNetwoking with your email and password!",
            },
            response_only=True,
            status_codes=["200"],
        ),
        OpenApiExample(
            "Email exist Error",
            value={
                "error": "Email has not been sign up , please check again!!!",
                "detail": "Please sign up again.",
            },
            response_only=True,
            status_codes=["400"],
        ),
    ...
    examples=[
        OpenApiExample(
            ...
            value={
                ...
                "detail": "X-CSRFToken will return in cookies. Please set X-CSRFToken header when send post, put, update method ",
            },
            response_only=True,
            status_codes=["200"],
        ),
        ...
        examples=[
            OpenApiExample(
                ...
                value={
                    ...
                    "detail": "Please use new password login again!",
                    "redirect": "/user/login/",
                },
                response_only=True,
                status_codes=["200"],
...
@extend_schema(
    ...
    examples=[
        OpenApiExample(
            "Send email success!",
            value={
                "message": "Link is sending to your mail!",
                "detail": "please reset password in 15 min!",
                "token": "token",
            },
            response_only=True,
            status_codes=["200"],
...
class EmailVertificationView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            return Response(
                {"error": "Email is not existed!,please try again"},
                status=status.HTTP_400_BAD_REQUEST,
            )
        except ValidationError as val_err:
            print(val_err)
            return Response(
                {"error": f"{val_err}"}, status=status.HTTP_500_INTERNAL_SERVER_ERROR
            )
...
@extend_schema(
    ...
    examples=[
        OpenApiExample(
            "Send email success!",
            value={
                "message": "Vertify code is sending to your mail!",
                "detail": "please reset password in 15 min!",
            },
            response_only=True,
            status_codes=["200"],
    ...
    def post(self, request):
        ...
        try:
            ...
            if content.get("usuage") != "reset_password":
                return Response(
                    {"error": "Wrong token with usuage "},
                    status=status.HTTP_401_UNAUTHORIZED,
                )
            email = content.get("email")
            if cache.get(f"Rest_password_{email}") == None:
                return Response(
                    {"error": "Wrong token with email !"},
                    status=status.HTTP_401_UNAUTHORIZED,
                )
            user = get_user_model().objects.filter(email=email).first()
            if not user:
                return Response(
                    {"error": "Wrong token with user!"},
                    status=status.HTTP_401_UNAUTHORIZED,
                )
            password = request.data.get("password")
            user.set_password(password)
            ...
            return Response(
                {
                    ...
                    "detal": "Use new password login again!",
                    "redirect": "/user/login/",
                },
                status=status.HTTP_200_OK,
            )
...
@extend_schema(
    ...
    examples=[
        OpenApiExample(
            "User created!",
            value={
                "message": "Email is resend, please check your email to active your account in 15 minutes !",
                "token": "Token that sendiing to email of user",
            },
            response_only=True,
            status_codes=["200"],
...
class ResendVertifyEmail(APIView):
    ...
    def post(self, request):
        ...
        if not email:
            return Response(
                {"error": "Email is requured!!", "detail": "Please provide an email ."},
                status=status.HTTP_400_BAD_REQUEST,
            )
        user = get_user_model().objects.filter(email=email).first()
        if not user:
            return Response(
                {"error": "Emaill is not be register, please sign up again!!"},
                status=status.HTTP_400_BAD_REQUEST,
            )
        current_time = int(datetime.now().timestamp())
        result = delete_unactivate_user.apply_async((email,), countdown=15 * 60)
...
class FollowViewSet(
    ...
    def list(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response(
                {"error": "Request data is invalid!"}, status.HTTP_400_BAD_REQUEST
            )
        except Exception as e:
            print(e)
            return Response(
    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            ...
            follow, created = UserFollowing.objects.get_or_create(
                user_id=user, following_user_id=following
            )
            if created:
                return Response(
                    {"message": "Follow the user!"}, status.HTTP_201_CREATED
                )
            elif follow:
                follow.delete()
